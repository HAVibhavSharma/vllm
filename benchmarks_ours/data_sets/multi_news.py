...
class MultiNews(Data_set):
    
    def load_data_from_hf(self):
        return load_dataset('THUDM/LongBench', 'multi_news', split='test').to_pandas()
    ...
    def _append_system_prompt(self, row: Dict) -> Dict:
        row['system_prompt'] = "You are given several news passages. Write a one-page summary of all news. \n\nNews:\n"
        return row
...
if __name__ == '__main__':
    ...
    dataset = MultiNews(tokenizer=tokenizer)
